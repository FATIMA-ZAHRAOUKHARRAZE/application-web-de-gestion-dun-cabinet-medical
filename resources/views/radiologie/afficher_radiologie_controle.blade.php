...
<div class="container">
    ...
    <form action="{{url('radiologie/'.$radiologie->num_radiologie.'/modifier_radiologie_controle')}}" method="post">
    ...
    <div class="row">
        ...
        <div class="mt-3">
            ...
            <a href="{{url('radiologie/'.$randomcontrole.'/radiologie_controle')}}" class="btn btn-secondary">Annuler</a>
        </div>
        </form>
    </div>
@endsection