...
<div class="container">
    ...
    <form action="{{url('analyse/'.$analyse->num_analyse.'/modifier_analyse_controle')}}" method="post">
    ...
    <div class="mt-3">
        ...
        <a href="{{url('analyse/'.$randomcontrole.'/analyse_controle')}}" class="btn btn-secondary">Annuler</a>
    </div>
    </form>
</div>
</div>
