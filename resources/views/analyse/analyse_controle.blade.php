...
<div class="container">
    ...
    <div class="card ">
        ...
        <form action="{{url('analyse/analyse_controle')}}" method="post">
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="mb-5">
                ...
                <a href="{{url('analyse/pdf_controle')}}" class="btn btn-primary"><i class="fa-solid fa-print"></i> Imprimer</a>
        ...
        <tbody class="table-group-divider" >
            @forelse ($analyses as $analyse)
                        <tr>
                            ...
                            <td>
                                <form action="{{url('analyse/'.$analyse->num_analyse.'/delete_analyse_controle')}}" method="POST">
                                    {{ csrf_field() }}
                                    {{method_field('DELETE')}}
                                    <a href="{{url('analyse/'.$analyse->num_analyse.'/afficher_analyse_controle')}}" class="btn btn-primary"><i class="fa-solid fa-eye" title="afficher"></i></a>
