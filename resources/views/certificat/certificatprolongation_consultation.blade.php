...
<div class="container">
    <div class="row">
        ...
        <div class="card-header">
            <h3>Ajouter Certificat Prolongation</h3>
        </div>
        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
            <div class="tab-content">
                <div  class="tab-pane fade show active pt-3">
    
        <form action="{{url('certificat/certificatprolongation_consultation')}}" method="post">
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                ...
                <input type="text" name="cin_patient" class="form-control" value="{{$consultation->cin}}" readonly>
            </div>
            <div class="col-md-6 col-12">
            ...
            <div class="mt-3">
                ...
                <a href="{{url('certificat/afficher_certificatprolongation_consultation')}}" class="btn btn-primary">Afficher</a>    
                <a href="{{url('certificat/pdf_prolongation_consultation')}}" class="btn btn-primary"><i class="fa-solid fa-print"></i> Imprimer</a>
