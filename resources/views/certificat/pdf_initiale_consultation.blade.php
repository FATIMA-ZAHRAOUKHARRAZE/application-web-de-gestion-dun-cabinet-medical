...
<br>
            ...
            <p>Certifié avoir examiné ce jour Mr(Mme):<span>
                {{$consultation->nom_patient}}</span><span> {{$consultation->prenom_patient}} </span></p>
<p>habitant:{{$consultation->adresse_patient}}</p>
<p> et atteste que son état de santé</p>
    <div id="contenu">
            @forelse ($certificat as $certificat)
         <p>Nécessite un traitement avec arret de travail de:<span>
