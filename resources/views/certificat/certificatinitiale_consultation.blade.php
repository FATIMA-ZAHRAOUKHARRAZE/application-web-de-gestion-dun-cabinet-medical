...
<div class="container">
    <div class="row">
        ...
        <form action="{{url('certificat/certificatinitiale_consultation')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="mt-3">
                ...
                <a href="{{url('certificat/afficher_certificatinitiale_consultation')}}" class="btn btn-primary">Afficher</a>    
                <a href="{{url('certificat/pdf_initiale_consultation')}}" class="btn btn-primary"><i class="fa-solid fa-print"></i> Imprimer</a>
