...
<div class="container">
    ...
    <div class="card ">
        ...
        <form action="{{url('certificat/'.$certificat->num_certificat.'/modifier_certificatinitiale_controle')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="mt-3">
                ...
                <a href="{{url('certificat/'.$randomcontrole.'/certificatinitiale_controle')}}" class="btn btn-secondary">Annuler</a>
