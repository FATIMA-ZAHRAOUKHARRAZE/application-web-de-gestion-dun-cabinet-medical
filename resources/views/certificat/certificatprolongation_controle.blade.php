...
<div class="container">
    ...
    <div class="card ">
        ...
        <form action="{{url('certificat/certificatprolongation_controle')}}" method="post"> 
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="mt-3">
                ...
                <a href="{{url('certificat/afficher_certificatprolongation_controle')}}" class="btn btn-primary">Afficher</a> 
                <a href="{{url('certificat/pdf_prolongation_controle')}}" class="btn btn-primary"><i class="fa-solid fa-print"></i> Imprimer</a>
