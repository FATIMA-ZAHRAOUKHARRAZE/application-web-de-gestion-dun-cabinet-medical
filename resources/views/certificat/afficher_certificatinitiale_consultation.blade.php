...
<div class="container">
    <div class="row">
        ...
        <form action="{{url('certificat/'.$certificat->num_certificat.'/modifier_certificatinitiale_consultation')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="mt-3">
                ...
                <a href="{{url('certificat/'.$randomNumber.'/certificatinitiale_consultation')}}" class="btn btn-secondary">Annuler</a>
