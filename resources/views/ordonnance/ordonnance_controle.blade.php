...
<div class="container">
    ...
    <div class="card">
        ...
        <form action="{{url('ordonnance/ordonnance_controle')}}" method="post">
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="mb-5">
                ...
                <a href="{{url('ordonnance/pdf_controle')}}" class="btn btn-primary"><i class="fa-solid fa-print"></i> Imprimer</a>
    ...
    <tbody class="table-group-divider" >
        @forelse ($ordonnances as $ordonnance)
                    <tr>
                        ...
                        <td>
                            <form action="{{url('ordonnance/'.$ordonnance->num_ordonnance.'/delete_ordonnance_controle')}}" method="POST">
                                {{ csrf_field() }}
                                {{method_field('DELETE')}}
                                <a href="{{url('ordonnance/'.$ordonnance->num_ordonnance.'/afficher_ordonnance_controle')}}" class="btn btn-primary"><i class="fa-solid fa-eye" title="afficher"></i></a>
