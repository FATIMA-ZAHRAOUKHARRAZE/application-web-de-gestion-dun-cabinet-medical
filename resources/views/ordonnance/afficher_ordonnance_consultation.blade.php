...
<div class="container">
    ...
    <form action="{{url('ordonnance/'.$ordonnance->num_ordonnance.'/modifier_ordonnance_consultation')}}" method="post">
    ...
    <div class="row">
        ...
        <div class="mt-3">
            ...
            <a href="{{url('ordonnance/'.$randomNumber.'/ordonnance_consultation')}}" class="btn btn-secondary">Annuler</a>
        </div>
</form>
</div>
</div>
